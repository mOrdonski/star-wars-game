...
import { species } from '../../shared/mock';
...
describe('SpeciesComponent', () => {
  ...
  it('should execute countResults method after play()', () => {
    starWarsServiceSpy.getRandomSpecies.and.returnValues(of({}), of({}));

    spyOn(component, 'countResults').and.callThrough();

    component.play();

    component.twoRandomSpecies$.subscribe();
